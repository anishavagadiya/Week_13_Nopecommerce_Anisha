...
public class ElectronicsTest extends Utility {
    ...
    public void verifyUserShouldNavigateToCellPhonesPageSuccessfully() {
        ...
        Assert.assertEquals("Cell phones not displayed", expectedText, actualText);
    }
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        String actualProduct = getTextFromElement(By.xpath("//h1[contains(text(),'Nokia Lumia 1020')]"));
        //Validate expected and actual result
        Assert.assertEquals("Nokia Lumia 1020 not displayed", expectedProduct, actualProduct);
        ...
        WebElement Quality = driver.findElement(By.id("product_enteredQuantity_20"));
        Quality.clear();
        Quality.sendKeys("2");
        ...
        Thread.sleep(3000);
        // verifyText(By.xpath("//input[@id = 'itemquantity11220']"),"2");

        //2.14 Verify the Total $698.00
        verifyText(By.xpath("//body[1]/div[6]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/form[1]/div[3]/div[2]/div[1]/table[1]/tbody[1]/tr[4]/td[2]/span[1]/strong[1]"), "$698.00");
        ...
        Thread.sleep(2000);
        sendTextToElement(By.id("FirstName"), "Jo"); //Enter first name
        sendTextToElement(By.id("LastName"), "Patel"); //Enter Last Name
        selectByValueFromDropDown(By.name("DateOfBirthDay"), "5");
        selectByValueFromDropDown(By.name("DateOfBirthMonth"), "4");
        Thread.sleep(2000);
        selectByValueFromDropDown(By.name("DateOfBirthYear"), "2000");
        sendTextToElement(By.id("Email"), "patel657@gmail.com");
        sendTextToElement(By.id("Password"), "Test1234");
        sendTextToElement(By.id("ConfirmPassword"), "Test1234");
        ...
        sendTextToElement(By.id("BillingNewAddress_Email"), "");
        Thread.sleep(2000);
        ...
        sendTextToElement(By.id("BillingNewAddress_Address1"), "34 Oxford Street");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "W1 2SR ");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "985236526565");
